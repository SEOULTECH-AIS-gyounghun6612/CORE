...
// 입력 1 (binding=0): 정렬된 인덱스 배열 (uint)
...
void main() {
    ...
    // 1. 정렬된 인덱스 버퍼에서 내가 가져와야 할 데이터의 '원본 위치'를 찾음
    uint original_idx = sorted_indices[id];
